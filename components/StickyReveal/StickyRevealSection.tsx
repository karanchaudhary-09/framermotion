...
export default function StickyRevealSection() {
  ...
  return (
    <div className="sticky-reveal-container relative w-full bg-gray-300 flex justify-between">
      <div className="relative">
        <div className="sticky-header w-[30vw] pb-[60vh] px-10 sticky top-[25vh] flex flex-col gap-20 justify-center">
