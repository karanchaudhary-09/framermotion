...
export default function ContactForm() {
  ...
  return (
    <div className="contact-form-wrapper w-[80vw] flex flex-col justify-center items-center rounded-xl overflow-hidden ">
      ...
      <form className="contact-form w-full bg-black flex flex-col justify-center items-center gap-14  px-4 py-10 lg:p-14">
        ...
        <textarea
          ...
          className="w-full bg-primaryBlue text-white px-4 py-3 text-lg rounded-lg focus:outline-none focus:ring-2 focus:ring-primaryShade focus:ring-opacity-50 focus:bg-primaryShade focus:text-primaryBlue"
        ></textarea>
        <button className=" w-full lg:w-[18vw] p-5 rounded-lg bg-primaryOrange text-white font-bold text-nowrap text-sm lg:text-xl shadow-lg shadow-slate-300 hover:shadow-none">
          Send Message
        </button>
      </form>
    </div>
